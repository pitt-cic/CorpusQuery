      ...
      <div className="container relative z-10">
        ...
        >
          <h2 className="font-serif text-3xl md:text-4xl font-medium mb-4 text-[var(--color-ink)]">
            Ready to Query <span className="text-gradient">Your Corpus</span>?
          </h2>
          <p className="text-[var(--color-ink-muted)] mb-8">
            Explore the codebase, deploy your own instance, or reach out to learn more.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="#demo"
              className="px-6 py-3 rounded-lg border border-[var(--color-border)] text-[var(--color-ink-muted)] hover:border-[var(--color-border-gold)] hover:text-[var(--color-gold-dark)] transition-colors inline-flex items-center gap-2"
            >
